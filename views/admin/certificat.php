...
if ( isset($_GET['valider'])  ){
    ...
    $subjet = "Validation de certificat de nationalité";
...
if ( isset($_GET['annuler'])  ){
    ...
    $subjet = "Rejet de certificat de nationalité";
...
<?php foreach($all_certificat as $certificat){
     ...
     ?>
                            <tr>
                                ...
                                <td class="col statut-cell"> <?php echo $certificat['statut'] != null ? $certificat['statut'] : '---Néant---'; ?> </td>
